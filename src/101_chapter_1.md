...
](gfx/101_chapter_1/Standard_Model_of_Elementary_Particles.pdf){#fig:standard_model_particles .vector width=70%}
...
arount it.
](gfx/101_chapter_1/mexican_hat.pdf){#fig:mexican_hat .vector width=60%}
...
](gfx/101_chapter_1/nnpdf31nnlo-10.pdf){#fig:pdf_low .vector width=49%}
![High Energy Scale $\mu^2 = 10^4 \textrm{GeV}^2$
](gfx/101_chapter_1/nnpdf31nnlo-1e4.pdf){#fig:pdf_high .vector width=49%}
...
](gfx/101_chapter_1/event_shower.pdf){#fig:event_shower width=70%}
